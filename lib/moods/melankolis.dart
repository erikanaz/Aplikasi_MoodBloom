...
class MelankolisPage extends StatelessWidget {
  const MelankolisPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // Filter destinasi bertipe 'bahagia'
    final List<DestinationItem> bahagiaDestinations = destinationList
        .where((destination) => destination.type == "melankolis")
        .toList();

    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        title: const Text("Melankolis"),
