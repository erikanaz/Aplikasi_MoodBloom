...
class RomantisPage extends StatelessWidget {
  const RomantisPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // Filter destinasi bertipe 'bahagia'
    final List<DestinationItem> bahagiaDestinations = destinationList
        .where((destination) => destination.type == "romantis")
        .toList();

    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        title: const Text("Romantis"),
